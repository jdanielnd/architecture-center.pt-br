...
## <a name="ai-scenarios"></a>Cenários de IA
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Chatbot de conversação para reservas de hotel</h3>
                        <p>Crie um chatbot de conversação para aplicativos de comércio com o Serviço de Bot do Azure.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Classificação de imagens para acionamento de seguro</h3>
                        <p>Crie o processamento de imagens em seus aplicativos do Azure.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Recomendações de filmes no Azure</h3>
                        <p>Use o aprendizado de máquina para automatizar recomendações de filmes, produtos ou qualquer outro item usando o aprendizado de máquina e as DSVM (Máquinas Virtuais de Ciência de Dados) do Azure para treinar um modelo no Azure.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Ingestão em massa e análise de feeds de notícias no Azure</h3>
                        <p>Crie um pipeline para a ingestão e análise de texto, imagens, sentimento e outros dados de feeds de notícias RSS usando apenas os serviços do Azure, incluindo o Azure Cosmos DB e os Serviços Cognitivos do Azure.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Migrando um aplicativo Web para uma arquitetura baseada em API</h3>
                        <p>Use o Gerenciamento de API do Azure para modernizar um aplicativo Web herdado.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Relação de confiança descentralizada entre bancos</h3>
                        <p>Estabeleça um ambiente confiável para comunicação e compartilhamento de informações sem recorrer a um banco de dados centralizado.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Crie um pipeline de CI/CD usando o Azure DevOps</h3>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Pipeline de CI/CD para cargas de trabalho baseados em contêiner</h3>
                        <p>Crie um pipeline DevOps para um aplicativo Web Node.js que usa Jenkins, Registro de Contêiner do Azure, Serviço de Kubernetes do Azure, Cosmos DB e Grafana.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Front-end de comércio eletrônico</h3>
                        <p>Hospede um site de comércio eletrônico no Azure.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Mecanismo de pesquisa de produto inteligente para comércio eletrônico</h3>
                        <p>Fornece uma experiência de pesquisa de nível internacional em um aplicativo de comércio eletrônico.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Um serviço de engenharia auxiliada por computador</h3>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Executar um servidor Jenkins no Azure</h3>
                        <p>Arquitetura recomendada que mostra como implantar e operar um servidor Jenkins escalonável, de nível corporativo, no Azure protegido com o logon único (SSO).</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Ambientes de desenvolvimento/teste para cargas de trabalho do SAP</h3>
                        <p>Crie um ambiente de desenvolvimento/teste para cargas de trabalho do SAP.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Executar cargas de trabalho de produção do SAP usando um Oracle Database</h3>
                        <p>Execute uma implantação de produção do SAP no Azure usando um banco de dados Oracle.</p>
                    </div>
                </div>
            </div>
        </div>
...
## <a name="data-scenarios"></a>Cenários de dados
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Análise de dados e de IoT no setor da construção</h3>
                        <p>Use dispositivos de IoT e de análise de dados para fornecer gerenciamento e operação abrangentes de projetos de construção.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Data warehouse e análise de vendas e marketing</h3>
                        <p>Consolide dados de várias fontes e otimize a análise de dados.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Processamento de pedidos escalonável</h3>
                        <p>Crie um pipeline de processamento de pedidos altamente escalonável usando o Azure Cosmos DB.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Detecção de fraude em tempo real</h3>
                        <p>Detecte atividades fraudulentas em tempo real usando os Hubs de Eventos do Azure e o Stream Analytics.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>ETL Híbrido com SSIS local existente e Azure Data Factory</h3>
                        <p>ETL Híbrido com implantações SSIS (SQL Server Integration Services) locais existentes e Azure Data Factory.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Ingestão e processamento de dados de IoT automotivos em tempo real</h3>
                        <p>Ingira e processe dados do veículo em tempo real usando IoT.</p>
                    </div>
                </div>
            </div>
        </div>
...
## <a name="infrastructure-scenarios"></a>Cenários de infraestrutura
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Executando simulações da CFD</h3>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Acelerar a modelagem baseada em imagem digital no Azure</h3>
                        <p>Acelere a modelagem baseada em imagem digital no Azure usando o Avere e o Agisoft PhotoScan</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Áreas de trabalho virtuais do Linux com o Citrix</h3>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Aplicativo Web de várias camadas criado para HA/DR</h3>
                        <p>Crie um aplicativo Web de várias camadas projetado para alta disponibilidade e recuperação de desastres no Azure usando máquinas virtuais do Azure, conjuntos de disponibilidade, zonas de disponibilidade, Azure Site Recovery e Gerenciador de Tráfego do Azure.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Compilando aplicativos Web seguros com VMs do Windows</h3>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Usando o Service Fabric para decompor aplicativos</h3>
                        <p>Decomponha um grande aplicativo monolítico em microsserviços.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Renderização de vídeo 3D</h3>
                        <p>Execute cargas de trabalho de HPC nativas no Azure usando o serviço de Lote do Azure.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Sites altamente escalonáveis e seguros do WordPress</h3>
                        <p>Crie um site do WordPress altamente escalonável e seguro para eventos de mídia.</p>
                    </div>
                </div>
            </div>
        </div>
