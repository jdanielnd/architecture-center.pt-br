            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card">
                        ...
                        <div class="cardText">
                            <h3>Envie suas ideias para o Centro de Arquitetura</h3>
                            <p>Você tem ideias para a nova documentação de arquitetura ou design?</p>
                            <p>Que tipos de artigos você gostaria de acessar no Centro de Arquitetura do Azure?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3> Pilares de uma ótima arquitetura do Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3> Design para segurança no Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Design para desempenho e escalabilidade no Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Design para eficiência e operações no Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Design para disponibilidade e capacidade de recuperação no Azure</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Tour pelo estilo de arquitetura de N camadas</h3>
                    </div>
                </div>
            </div>
        </div>
