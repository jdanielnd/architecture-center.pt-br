...
## <a name="availability-considerations---traffic-manager"></a>Considerações sobre disponibilidade - Gerenciador de Tráfego
...
## <a name="availability-considerations---sql-database"></a>Considerações sobre disponibilidade - Banco de Dados SQL
...
## <a name="availability-considerations---storage"></a>Considerações sobre disponibilidade - Armazenamento
...
## <a name="manageability-considerations---traffic-manager"></a>Considerações sobre capacidade de gerenciamento - Gerenciador de Tráfego
...
## <a name="manageability-considerations---sql-database"></a>Considerações sobre capacidade de gerenciamento - Banco de Dados SQL
