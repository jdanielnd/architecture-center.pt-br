---
title: "Executar VMs do Windows em várias regiões do Azure para ter alta disponibilidade"
...
Para obter mais informações, consulte [VMs do Windows em execução para uma arquitetura de N camadas no Azure](n-tier.md).
