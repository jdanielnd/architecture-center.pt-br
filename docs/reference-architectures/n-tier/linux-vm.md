...
ms.locfileid: "50916661"
---
# <a name="run-a-linux-vm-on-azure"></a>Executar uma VM do Linux no Azure

Esse artigo descreve um conjunto de práticas comprovadas para executar uma VM (máquina virtual) do Linux no Azure. Ela inclui recomendações para provisionar a VM juntamente com os componentes de rede e armazenamento. [**Implante essa solução.**](#deploy-the-solution)
