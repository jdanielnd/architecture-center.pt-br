...
- Considere o uso [replicação geográfica][sql-geo-replication] ativa para a camada de dados e armazenamento com [redundância geográfica][storage-geo-redundancy] para imagens e filas.
