...
* **Visual Studio Code**: um ambiente de codificação leve e de multiplaforma que dá suporte ao Python, bem como a estruturas geralmente usadas para aprendizado de máquina e desenvolvimento de IA.
...
Quando estiver pronto para implantar o modelo, use o ambiente do Workbench para empacotar o modelo e implantá-lo como um serviço Web em um contêiner do Docker, no Spark no Azure HDinsight, no Microsoft Machine Learning Server ou no SQL Server. Em seguida, o serviço Gerenciamento de Modelos do Azure Machine Learning permite acompanhar e gerenciar implantações de modelo na nuvem, em dispositivos de borda ou em toda a empresa.
...
Considerações:
* Exige um pouco de familiaridade com o modelo de gerenciamento de modelos e o ambiente da ferramenta Workbench.
...
* Implante modelos diretamente no Spark no HDinsight por meio do Azure Machine Learning Workbench e gerencie-os usando o serviço Gerenciamento de Modelos do Azure Machine Learning.
...
* Implante em um contêiner diretamente por meio do Azure Machine Learning Workbench.
...
* Alta escalabilidade.
* Implantação direta por meio do Azure Machine Learning Workbench.
