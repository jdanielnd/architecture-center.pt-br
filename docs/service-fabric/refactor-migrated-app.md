...
A função Web **Tailspin.Web.Survey.Public** também hospeda um site ASP.NET MVC que o público acessa para preencher as pesquisas. Essas respostas são colocadas em uma fila para serem salvas.
