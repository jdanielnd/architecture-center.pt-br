...
4. Em **Função**, selecione **Proprietário**.
5. Digite o endereço de email do usuário que você deseja adicionar como proprietário.
6. Selecione o usuário e clique em **Salvar**.
...
2. Execute SetupKeyVault.ps outra vez da seguinte maneira:
