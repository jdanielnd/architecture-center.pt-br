...
description: Orientação sobre como usar CDNs (Redes de Distribuição de Conteúdo) para fornecer conteúdo de alta largura de banda hospedado no Azure.
author: dragon119
ms.date: 02/02/2018
...
ms.locfileid: "58249101"
---
# <a name="content-delivery-networks-cdns"></a>CDNs (Redes de Distribuição de Conteúdo)
...
Este tópico descreve algumas das melhores práticas gerais e considerações ao usar uma CDN. Para saber mais, confira [CDN do Azure](/azure/cdn/).
