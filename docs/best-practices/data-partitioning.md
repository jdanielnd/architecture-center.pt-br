...
> [!NOTE]
> Você pode armazenar um conjunto limitado de tipos de dados em documentos pesquisáveis, incluindo cadeias de caracteres, boolianos, dados numéricos, dados de data/hora e alguns dados geográficos. Para obter mais detalhes, visite a página [Supported data types (Azure Search)] no site da Microsoft.
>
>
...
* O artigo [Uso da Rede de Distribuição de Conteúdo do Azure] , no site da Microsoft, fornece instruções adicionais sobre como configurar e usar a Rede de Distribuição de Conteúdo com o Azure.
...
[Uso da Rede de Distribuição de Conteúdo do Azure]: /azure/cdn/cdn-create-new-endpoint
