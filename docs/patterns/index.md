...
<tr>
    ...
    <td>
        ...
        <p>A segurança é a capacidade de um sistema impedir ações acidentais ou mal-intencionadas fora do uso projetado e evitar a divulgação ou a perda de informações. Os aplicativos de nuvem são expostos na Internet fora dos limites de locais confiáveis e geralmente são abertos ao público e podem atender a usuários não confiáveis. Os aplicativos devem ser criados e implantados de maneira que protejam contra ataques mal-intencionados, restrinjam o acesso a somente usuários aprovados e protejam dados confidenciais.</p>
    </td>
</tr>
</table>
<!-- markdownlint-disable MD033 -->
