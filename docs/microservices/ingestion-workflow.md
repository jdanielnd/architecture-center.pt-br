...
Analisamos três opções para ler e processar as mensagens: o Host do Processador de Eventos, as filas de Barramento de Serviço e a biblioteca do IoTHub React. Escolhemos o IoTHub React, mas para entender o porquê, será mais fácil começar pelo Host do Processador de Eventos.
