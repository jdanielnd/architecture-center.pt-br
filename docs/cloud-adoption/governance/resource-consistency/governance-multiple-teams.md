...
8. O **administrador de serviço** então adiciona o **proprietário da carga de trabalho B** ao **grupo de recursos B** e atribui a [função colaborador interna](/azure/role-based-access-control/built-in-roles#contributor).
...
![O proprietário da conta do Azure cria uma assinatura](../../_images/governance-3-0b.png)
...
![O proprietário da conta do Azure adiciona a conta de usuário do proprietário da assinatura para a assinatura com a função proprietário](../../_images/governance-3-0c.png)
